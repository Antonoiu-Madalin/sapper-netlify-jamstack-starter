<style>
  ...
  * {
  ...
  .card {
    position: relative;
    background: #0af; /*Specific to React content part, not svg #0af , #fc6621; svelte , #42b883 vue*/
    display: flex;
    border-radius: 6px;
    color: #151d28;
    overflow: hidden;
  ...
  .card:hover{
     box-shadow: 0 7px 14px#0af, 0 10px 10px rgba(0, 0, 0, 0.22);
  }
  ...
  <a href="/portfolio">
    <div class="card">
      <div class="card__image-container">
        <img
          class="card__image"
          src="https://images.unsplash.com/photo-1526948128573-703ee1aeb6fa?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=351&ixid=eyJhcHBfaWQiOjF9&ixlib=rb-1.2.1&q=80&w=439"
          alt="" />
      </div>
